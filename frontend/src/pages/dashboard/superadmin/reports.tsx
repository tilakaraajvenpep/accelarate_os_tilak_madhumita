          ...
          <TableBody>
            {coupons?.coupons.map((c) => (
              <TableRow key={c.id}>
                ...
                <TableCell>
                  <Badge variant={c.active ? 'success' : 'secondary'}>{c.active ? t('common:active') : t('common:inactive')}</Badge>
                </TableCell>
              </TableRow>
            ))}
            {coupons && coupons.coupons.length === 0 && (
              <TableRow>
                <TableCell colSpan={6} className="text-center py-10">
                  ...
                  <p className="text-sm text-muted-foreground">{t('couponsTable.empty')}</p>
                </TableCell>
              </TableRow>
            )}
          </TableBody>
            ...
            {transactions.length === 0 && (
              <TableRow>
                <TableCell colSpan={6} className="text-center py-10">
                  ...
                  <p className="text-sm text-muted-foreground">{t('transactionsTable.empty')}</p>
                </TableCell>
              </TableRow>
            )}
          </TableBody>

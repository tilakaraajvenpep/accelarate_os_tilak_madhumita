...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-sm leading-normal font-normal text-muted-foreground [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary",
        className
      )}
      {...props}
    />
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <Separator className="absolute inset-0 top-1/2 bg-white/10" />
      {children && (
        <span className="relative mx-auto block w-fit bg-transparent px-2 text-muted-foreground">
          {children}
        </span>
      )}
    </div>
...
export {
  ...
  FieldGroup, FieldLegend, FieldSeparator, FieldSet,
